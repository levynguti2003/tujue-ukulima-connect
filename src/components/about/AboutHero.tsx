...
const AboutHero = () => {
  return (
    <div className="relative bg-gradient-to-b from-tu-green-100 to-white py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          <GraduationCap className="h-14 w-14 text-tu-green-600 mb-4" />
          <h1 className="text-3xl md:text-5xl font-bold text-tu-green-700 mb-6">
            Who We Are
          </h1>
